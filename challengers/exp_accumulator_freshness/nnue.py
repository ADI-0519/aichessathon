...
def update_for_move(
    ...
    # Search can reach this update without evaluating the parent first: a TT
    # return or qeval-cache hit may skip refresh after a king crossed a bucket.
    # Incremental deltas are valid only relative to the parent's actual bucket.
