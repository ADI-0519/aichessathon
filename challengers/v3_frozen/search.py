...
try:  # keep the frozen pair together: a package import must not reach the root
    from . import engine
except ImportError:  # pragma: no cover - used when this directory is an agent root
