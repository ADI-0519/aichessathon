...
| V12 last-day release candidate | Search V10 plus signed history/quiet SEE, adaptive completed-iteration timing, stale king-bucket accumulator repair, and post-pruning qsearch accumulator updates. With S1 disabled, all six 100k critical probes exactly matched current in move, score, depth, nodes, qnodes, TT cutoffs and LMR counts. Incremental-update tests cover special moves, bucket crossing and 100+ random positions; a two-colour smoke scored 1-0-1 with zero failures; packaged size is 5.91 MB compressed and 6.46 MB expanded. | Await one 20-pair holdout match against current. This is deliberately a combined release candidate; do not promote merely from the critical-position screen. |
